...
class VariantController(http.Controller):
    @http.route(['/l10n_ec_balcon/get_combination_info'], type='json', auth="user", methods=['POST'])
    ...
    @http.route(['/l10n_ec_balcon/create_product_variant'], type='json', auth="user", methods=['POST'])
