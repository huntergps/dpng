...
class PaymentWizard(models.TransientModel):
    ...
    _name = 'l10n_ec_balcon.payment.acquirer.onboarding.wizard'
    _description = 'Balcon Payment acquire onboarding wizard'

    def _get_default_payment_method(self):
        return self.env.company.balcon_onboarding_payment_method or 'digital_signature'
    ...
    def _set_payment_acquirer_onboarding_step_done(self):
        """ Override. """
        self.env.company.sudo().set_onboarding_step_done('balcon_onboarding_order_confirmation_state')

    def add_payment_methods(self, *args, **kwargs):
        self.env.company.balcon_onboarding_payment_method = self.payment_method
