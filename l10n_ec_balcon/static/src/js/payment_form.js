odoo.define('l10n_ec_balcon.payment_form', require => {
    'use strict';
    ...
    const salePaymentMixin = {
        ...
        /**
         * Add `balcon_order_id` to the transaction route params if it is provided.
         *
        ...
        _prepareTransactionRouteParams: function (provider, paymentOptionId, flow) {
            ...
            return {
                ...
                'balcon_order_id': this.txContext.saleOrderId
