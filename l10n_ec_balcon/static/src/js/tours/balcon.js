odoo.define('l10n_ec_balcon.tour', function(require) {
"use strict";
...
tour.register("balcon_tour", {
    url: "/web",
    rainbowMan: false,
    sequence: 20,
}, [tour.stepUtils.showAppsMenuItem(), {
    trigger: ".o_app[data-menu-xmlid='l10n_ec_balcon.balcon_menu_root']",
    ...
    trigger: 'a.o_onboarding_step_action.btn[data-method=action_open_balcon_onboarding_payment_acquirer]',
    extra_trigger: ".o_balcon_order",
    ...
    trigger: 'a.o_onboarding_step_action.btn[data-method=action_open_balcon_onboarding_sample_quotation]',
    extra_trigger: ".o_balcon_order",
    content: _t("Now, we'll create a sample quote."),
    position: "bottom",
}]);

tour.register("balcon_quote_tour", {
