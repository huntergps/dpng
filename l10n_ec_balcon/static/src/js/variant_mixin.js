odoo.define('l10n_ec_balcon.VariantMixin', function (require) {
'use strict';
...
var VariantMixin = {
    ...
    _getCombinationInfo: function (ev) {
        ...
        if ($parent.hasClass('main_product')) {
            ...
            for (const optionalProduct of $optProducts) {
                ...
                ajax.jsonRpc(this._getUri('/l10n_ec_balcon/get_combination_info'), 'call', {
        ...
        return ajax.jsonRpc(this._getUri('/l10n_ec_balcon/get_combination_info'), 'call', {
    ...
    selectOrCreateProduct: function ($container, productId, productTemplateId, useAjax) {
        ...
        if (productId) {
            ...
            var route = '/l10n_ec_balcon/create_product_variant';
            if (useAjax) {
