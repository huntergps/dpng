odoo.define('l10n_ec_balcon.product_configurator', function (require) {
 ...
 * !!! WARNING !!!
 *
 * This widget is only designed for balcon_order_line creation/updates.
...
var ProductConfiguratorWidget = relationalFields.FieldMany2One.extend({
     ...
     * (options, ...).
     * Allows balcon_product_configurator module to apply its options
