...
class BalconOrderCancel(models.TransientModel):
    _name = 'balcon.order.cancel'
    _description = "Ordenes de Servicios Cancel"

    order_id = fields.Many2one('balcon.order', string='Sale Order', required=True, ondelete='cascade')
