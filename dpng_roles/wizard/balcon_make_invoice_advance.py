...
class SaleAdvancePaymentInv(models.TransientModel):
    _name = "balcon.advance.payment.inv"
    ...
    def _default_product_id(self):
        product_id = self.env['ir.config_parameter'].sudo().get_param('balcon.default_deposit_product_id')
    ...
    def _prepare_invoice_values(self, order, name, amount, so_line):
        invoice_vals = {
            ...
            'invoice_line_ids': [(0, 0, {
                ...
                'balcon_line_ids': [(6, 0, [so_line.id])],
            })],
        }
    ...
    def create_invoices(self):
        ...
        if self.advance_payment_method == 'delivered':
            ...
            if not self.product_id:
                ...
                self.env['ir.config_parameter'].sudo().set_param('balcon.default_deposit_product_id', self.product_id.id)
            ...
            for order in balcon_orders:
                ...
                so_line = balcon_line_obj.create(so_line_values)
